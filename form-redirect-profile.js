            ...
            if (formMapping) {
                ...
                if (selectElement) {
                    ...
                    if (profil) {
                        ...
                        console.error("Aucune correspondance trouvée pour :", selectedValue);
                    }
                } else {
                    console.error("Champ <select> introuvable dans le formulaire :", formId);
                }
            } else {
                console.error("Formulaire introuvable dans le mapping :", formId);
            }
        };
